...
const MetaPairVector StrategyManager::getZergBuildOrderGoal() const
{
	...
	if (shouldExpandNow())
	{
		...
		//goal.push_back(std::pair<MetaType, int>(BWAPI::UnitTypes::Zerg_Drone, numWorkers + 15));
	}
	...
	//might want to push back spire, lair, spawn pool, and hydra den to keep them constant
